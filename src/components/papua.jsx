...
export default function Papua({ onMarkerClick, userXP = 0 }) {
    ...
    const fetchMarkers = async () => {
      const { data, error } = await supabase
        ...
        .select(`
          ...
          islands!inner(slug)
        `)
        .eq("islands.slug", "papua"); // ✅ sesuai DB kamu
  ...
  return (
    ...
    >
      <div className="relative">
        ...
        {/* 🔥 penting: biar gambar gak nutup klik */}
        <img
          ...
          return (
            ...
            >
              {unlocked ? (
                <div
                  onClick={(e) => {
                    console.log("CLICK:", m.name); // debug
