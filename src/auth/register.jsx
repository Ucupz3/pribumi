...
export default function Register() {
  ...
  const handleRegister = async (e) => {
        ...
        // Nanti ganti dengan: await fetch("https://api-temen.com/auth/register", { method: "POST", body: JSON.stringify({ fullName, email, password }) })
        setLoading(false);
        navigate("/login");
    };
    ...
    return (
        ...
        <div className="relative w-full lg:w-[65%] xl:w-[70%] hidden lg:flex items-center justify-center overflow-hidden">
            ...
            <div className="relative flex flex-col items-center">
                ...
                <div className="hidden items-center justify-center">
                    <h1 className="text-5xl lg:text-7xl font-black text-[#BD9B2C] drop-shadow-2xl" style={{ textShadow: "2px 2px 8px rgba(0,0,0,0.5)" }}>
                    Nusa Quest
                    </h1>
                </div>
        ...
        >
            ...
            <form onSubmit={handleRegister} className="space-y-3">
                ...
                />
                <label htmlFor="agreeTerms" className="text-[#5c4033] text-xs font-semibold cursor-pointer">
                    Saya menyetujui{" "}
                    <button type="button" className="text-[#BD9B2C] hover:underline">
                    Syarat & Ketentuan
                    </button>
                    {" "}dan{" "}
                    <button type="button" className="text-[#BD9B2C] hover:underline">
            ...
            <div className="flex items-center gap-3 my-4">
                ...
                <span className="text-[#5c4033] text-sm font-bold">Atau Daftar Dengan</span>
                <div className="flex-1 h-px bg-[#c9b896]" />
            </div>
